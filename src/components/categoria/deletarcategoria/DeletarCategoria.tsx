...
function DeletarCategoria() {
  ...
  return (
    ...
    <div className="border-2w-full max-w-2xl mx-auto bg-slate-100 text-gray-800 border border-gray-300 rounded-md px-8 py-6 my-6 shadow-sm hover:shadow-md transition-all duration-300">

        <h1 className="text-2xl font-bold mb-4 text-left text-red-600">
            Deletar categoria
        </h1>
